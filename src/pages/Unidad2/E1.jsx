  ...
  return (
    <ExerciseLayout number={1}>
      ...
      <GameTable
        ...
        payoffs={[
          ["($5;2$)", "($2;6$)", "($1;4$)", "($0;4$)"],
          ["($0;0$)", "$(\\textcolor{red}{3};2$)", "$(\\textcolor{red}{2};1$)", "($1;1$)"],
      ...
      <GameTable
        ...
        payoffs={[
          ...
          ["($0;0$)", "$(\\textcolor{red}{3};\\textcolor{red}{2}$)", "$(\\textcolor{red}{2};1$)", "($1;1$)"],
          ["($7;0$)", "($2;2$)", "$(1;\\textcolor{red}{5}$)", "$(\\textcolor{red}{5};1$)"],
          ["($\\textcolor{red}{9};5$)", "($1;3$)", "($0;2$)", "$(4;\\textcolor{red}{8}$)"],
        ]}
      />
      <p className="mt-2">
      ...
      <GameTable
        ...
        payoffs={[
          ...
          ["$(\\textcolor{red}{3};\\textcolor{red}{2}$)", "$(\\textcolor{red}{2};1$)", "($1;1$)"],
      ...
      <GameTable
        ...
        payoffs={[
          ...
          ["$(\\textcolor{red}{3};\\textcolor{red}{2}$)", "$(\\textcolor{red}{2};1$)"],
      ...
      <GameTable
        player1Strategies={["B"]}
        player2Strategies={["B", "C"]}
        payoffs={[["$(\\textcolor{red}{3};\\textcolor{red}{2}$)", "$(\\textcolor{red}{2};1$)"]]}
      />
      <p className="mt-2">
