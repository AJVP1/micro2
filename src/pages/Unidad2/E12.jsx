...
function Ejercicio12() {
  return (
    <ExerciseLayout number={12}>
      ...
      <p className="mt-2">Ahora tenemos que pensar en varios escenarios:</p>
      ...
      <p className="mt-2">
        Por lo tanto, los equilibrios de Nash en estrategias puras son: $m=6$
        y $m=7$. Ya que en ambos casos las firmas no tienen incentivos a
