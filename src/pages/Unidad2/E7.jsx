  ...
  return (
    <ExerciseLayout number={7}>
      ...
      <p className="mt-2 text-sm sm:text-base md:text-lg">
        La batalla de los sexos. Los dos integrantes de un matrimonio tienen que
        elegir una actividad para el fin de semana. Las actividades disponibles
        son ir al cine o ir al teatro. La mujer prefiere el teatro, mientras que
        el hombre prefiere el cine. Para ambos es mejor ir juntos que separados,
        aunque sea para realizar la actividad que prefiere el conyugue.
      </p>
