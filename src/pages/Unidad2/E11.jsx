  ...
  return (
    <ExerciseLayout number={11}>
      ...
      <ol className="list-decimal text-lg mt-4 pl-8">
        ...
        <li className="mt-2 text-sm sm:text-base md:text-lg">
          Encuentre todos los equilibrios de Nash en estrategias puras para este
          juego
        </li>
      </ol>
      ...
      <p className="mt-2 text-sm sm:text-base md:text-lg">
        Para el punto 1. A cada jugador le convendrá elegir el complemento de lo
        que eligió el otro jugador. Por lo tanto, las mejores respuestas ante la
        elección del oponente son:
      </p>
      <p className="mt-2 text-sm sm:text-base md:text-lg">
