  ...
  return (
    <ExerciseLayout number={9}>
      ...
      <p className="mt-2 text-sm sm:text-base md:text-lg">
        Conducta egoísta y altruista. Dos personas se suben a un colectivo. Hay
        dos lugares adyacentes varios. Cada persona debe decidir si sentarse o
        quedarse parada. Sentarse solo es más confortable que sentarse junto a
        otra persona, aunque esto último es más confortable que quedarse parado.
      </p>
      <ol className="list-decimal text-lg mt-4 pl-8">
        ...
        <li className="mt-2 text-sm sm:text-base md:text-lg">
          Suponga ahora que cada persona es altruista y ordena los resultados de
          acuerdo al confort de la otra persona. Además, por educación, prefiere
          quedarse parada que sentarse si la otra persona se queda parada.
          Modele esta situación como un juego estratégico. ¿Este juego es
          equivalente al "dilema del prisionero"? Encuentre los equilibrios de
          Nash.
        </li>
        <li className="mt-2 text-sm sm:text-base md:text-lg">
      ...
      <p className="mt-2 text-sm sm:text-base md:text-lg">
        Para el punto 1. Contruyamos la matriz de pagos, el anunciado nos indica
        que lo mejor es estar sentado solo, luego sentado junto a otro y por
        último parado. Por lo tanto, la matriz de pagos es:
      </p>
      <GameTable
      ...
      <p className="mt-2 text-sm sm:text-base md:text-lg">
        ...
        uno. En el caso en que uno se siente y otro no supondremos un pago de 2
        para el que se sienta y 0 para el que no se sienta. Y por ultimo, en el
        caso en que ambos se queden parados supondremos un pago de 0 para cada
        uno.
      </p>
      <p className="mt-2 text-sm sm:text-base md:text-lg">
      ...
      <p className="mt-2 text-sm sm:text-base md:text-lg">
        ...
        combinación de estrategias que mejore el pago de un jugador sin empeorar
        el pago del otro.
      </p>
      <p className="mt-2 text-sm sm:text-base md:text-lg">
