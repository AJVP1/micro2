      ...
      <section className="bg-[#fafafa] mx-auto p-6">
        ...
        <ol className="list-decimal text-lg mt-4 pl-8">
          ...
          <li className="mt-2">
            ...
            consumidor, en términos de excedente, que haya más empresas?
            Explique
          </li>
          <li className="mt-2">
            Encuentre las cantidades de equilibrio de Nash $s_i$ para $n = 2$,
            $a = 24$ y $c_i = 0$
          </li>
          <li className="mt-2">
            colusión: siguiendo con el caso 4., suponga que las empresas pueden
            firmar un acuerdo en el cual estipulan cuanto va a producir cada
            una. En particular, maximizan la suma de los beneficios de ambas
            empresas y dividen la cantidad total a producir por 2.
          </li>
          <ul className="list-disc text-lg mt-4 pl-8">
            ...
            <li className="mt-2">
              ¿Cómo afecta a las empresas, en términos de beneficios, y al
              consumidor, en términos de excedente, que exista un acuerdo de
              este tipo?
            </li>
            <li className="mt-2">
        ...
        <p className="mt-2">Condiciones de primer orden:</p>
        <p>
          {
            "$$\\frac{\\partial \\pi_i}{\\partial q_i} = 0  \\Rightarrow a-2q_i - \\sum q_-i - c_i = 0$$"
          }
        </p>
        <p className="mt-2">Despejando $q_i$ llegamos a:</p>
        <p className="mt-2">{"$$q_i = \\frac{a - \\sum q_{-i} - c_i}{2}$$"}</p>
        <p className="mt-2">
          ...
          empresa produce la misma cantidad. Por lo tanto, se puede reescribir
          la función de mejor respuesta de la empresa $i$ como
        </p>
        <p className="mt-2">
          {
        ...
        <p className="mt-2">Despejando $q$ llegamos a:</p>
        <p className="mt-2">{"$$q = \\frac{a - c_i}{n+1}$$"}</p>
        <p className="mt-2">
          {
        ...
        <p className="mt-2">{"$$q_i = \\frac{24}{2+1} = 8$$"}</p>
        <p className="mt-2">
          Por lo tanto, cada empresa produce 8 unidades en equilibrio de Nash.
        </p>
        <p className="mt-2">
          Para el punto 5.a, en una situación de colusión, las empresas
          maximizan la suma de sus beneficios conjuntos. La cantidad total
          producida se determina resolviendo:
        </p>
        <p className="mt-2">{"$$\\max_Q P(Q)Q = (24 - Q)Q = 24Q - Q^2$$"}</p>
        <p className="mt-2">Condiciones de primer orden:</p>
        <p className="mt-2">
          {
        ...
        <p className="mt-2">Despejando $Q$ llegamos a:</p>
        <p className="mt-2">{"$$Q = \\frac{24}{2} = 12$$"}</p>
        <p className="mt-2">
          Dado que las empresas dividen la cantidad total por 2, cada empresa
          produce:
        </p>
        <p className="mt-2">{"$$q_i = \\frac{Q}{2} = \\frac{24}{4} = 6$$"}</p>
        <p className="mt-2">
          Por lo tanto, en situación de colusión, cada empresa produce 6
          unidades.
        </p>
        <p className="mt-2">
        ...
        <p className="mt-2">{"$$\\pi_i = P(16)q_i = 8 \\times 8 = 64$$"}</p>
        <p className="mt-2">
          En situación de colusión, cada empresa produce 6 unidades a un precio
          de $P(12) = 24 - 12 = 12$, por lo que el beneficio de cada empresa es
        </p>
        <p className="mt-2">{"$$\\pi_i = P(12)q_i = 12 \\times 6 = 72$$"}</p>
        <p className="mt-2">
          Por lo tanto, los beneficios son mayores en la situación de colusión
          ($72$) en comparación con el equilibrio de Nash ($64$).
        </p>
        <p className="mt-2">
          Para el punto 5.c, la colusión beneficia a las empresas al aumentar
          sus beneficios individuales. Sin embargo, esto perjudica a los
          consumidores, ya que el precio es más alto y la cantidad disponible es
          menor en comparación con el equilibrio de Nash.
        </p>
        <p className="mt-2">
          Para el punto 5.d, el equilibrio de Nash encontrado en el punto 4 no
          es un óptimo de Pareto. En el equilibrio de Nash, ambas empresas
          producen más y el precio es más bajo, lo que beneficia a los
          consumidores. En la situación de colusión, aunque las empresas
          aumentan sus beneficios, los consumidores están peor debido al precio
          más alto y la menor cantidad disponible. Por lo tanto, no se puede
          mejorar la situación de una parte sin perjudicar a la otra, lo que
          indica que el equilibrio de Nash es un óptimo de Pareto.
        </p>
      </section>
    </MathJax>
  );
