  ...
  return (
    <ExerciseLayout number={10}>
      ...
      <p className="mt-2 text-sm sm:text-base md:text-lg">
        ...
        los cazadores persiguen a la liebre, logran atraparla y se la dividen en
        partes iguales. Sin embargo, si alguno de los cazadores atrapa un
      ...
      />
      <p className="mt-2 text-sm sm:text-base md:text-lg">
        Representando las mejores respuestas en la matriz de pagos.
      </p>
      <GameTable
        player1Strategies={["Liebre", "Conejo"]}
        player2Strategies={["Liebre", "Conejo"]}
